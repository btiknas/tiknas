...
[RemoteService] //Automatically enables API explorer and apply TIKNAS conventions.
//[ApiExplorerSettings(IgnoreApi = false)] //alternative
public class RegularTestController : TiknasController, IRegularTestController
{
    [HttpGet]
    [Route("increment")]
    ...
    {
        throw new BusinessException("Tiknas.Http.DynamicProxying:10001")
            .WithData("0","TEST");
    }
