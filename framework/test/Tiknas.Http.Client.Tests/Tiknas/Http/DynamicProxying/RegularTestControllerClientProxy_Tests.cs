...
public class RegularTestControllerClientProxy_Tests : TiknasHttpClientTestBase
{
    ...
    {
        var exception = await Assert.ThrowsAsync<TiknasRemoteCallException>(async () => await _controller.GetException1Async());
    ...
    {
        var exception = await Assert.ThrowsAsync<TiknasRemoteCallException>(async () => await _controller.GetException2Async());
    ...
    public async Task AbortRequestAsync()
    {
        ...
        var exception = await Assert.ThrowsAsync<TiknasRemoteCallException>(async () => await _controller.AbortRequestAsync(cts.Token));
