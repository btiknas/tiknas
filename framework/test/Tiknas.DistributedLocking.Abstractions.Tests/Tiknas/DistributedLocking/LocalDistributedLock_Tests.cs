...
public class LocalDistributedLock_Tests : TiknasDistributedLockingAbstractionsTestBase
{
    private readonly ITiknasDistributedLock _distributedLock;

    public LocalDistributedLock_Tests()
    {
        _distributedLock = GetRequiredService<ITiknasDistributedLock>();
    }

    [Fact]
    public void Should_Be_Instance_Of_LocalTiknasDistributedLock()
    {
        _distributedLock.ShouldBeOfType<LocalTiknasDistributedLock>();
    }
