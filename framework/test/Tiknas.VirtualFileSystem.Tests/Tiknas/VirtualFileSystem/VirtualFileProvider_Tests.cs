...
public class VirtualFileProvider_Tests : TiknasIntegratedTest<VirtualFileProvider_Tests.TestModule>
{
    ...
    [DependsOn(typeof(TiknasVirtualFileSystemModule))]
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            Configure<TiknasVirtualFileSystemOptions>(options =>
            {
                options.FileSets.AddEmbedded<TestModule>(
                    baseFolder: "/Tiknas/VirtualFileSystem/MyResources"
                );
            });
        }
    }
