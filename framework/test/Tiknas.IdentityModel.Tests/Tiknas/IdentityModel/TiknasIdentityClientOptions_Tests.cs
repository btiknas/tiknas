...
public class TiknasIdentityClientOptions_Tests : TiknasIdentityModelTestBase
{
    private readonly ICurrentTenant _currentTenant;
    private readonly TiknasIdentityClientOptions _identityClientOptions;

    public TiknasIdentityClientOptions_Tests()
    {
        _currentTenant = GetRequiredService<ICurrentTenant>();
        _identityClientOptions = GetRequiredService<IOptions<TiknasIdentityClientOptions>>().Value;
    }
