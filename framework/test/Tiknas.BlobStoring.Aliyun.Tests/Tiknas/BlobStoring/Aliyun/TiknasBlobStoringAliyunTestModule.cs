...
[DependsOn(
    typeof(TiknasBlobStoringAliyunModule),
    typeof(TiknasBlobStoringTestModule)
)]
public class TiknasBlobStoringAliyunTestCommonModule : TiknasModule
{

}

[DependsOn(
    typeof(TiknasBlobStoringAliyunTestCommonModule)
)]
public class TiknasBlobStoringAliyunTestModule : TiknasModule
{
    ...
    private readonly string _randomContainerName = "tiknas-aliyun-test-container-" + Guid.NewGuid().ToString("N");
