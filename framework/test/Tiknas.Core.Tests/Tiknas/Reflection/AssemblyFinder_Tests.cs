...
public class AssemblyFinder_Tests
{
    ...
    private static IModuleContainer CreateFakeModuleContainer(List<ITiknasModuleDescriptor> moduleDescriptors)
    {
    ...
    private static ITiknasModuleDescriptor CreateModuleDescriptor(Type moduleType)
    {
        var moduleDescriptor = Substitute.For<ITiknasModuleDescriptor>();
