...
public class TiknasLocalization_Tests : TiknasIntegratedTest<TiknasLocalizationTestModule>
{
    private readonly IStringLocalizer<LocalizationTestResource> _localizer;
    private readonly IStringLocalizerFactory _localizerFactory;

    public TiknasLocalization_Tests()
    {
    ...
    [Fact]
    public void TiknasStringLocalizerExtensions_GetInternalLocalizer()
    {
        var internalLocalizer = _localizer.GetInternalLocalizer();
        internalLocalizer.ShouldNotBeNull();
        internalLocalizer.ShouldBeOfType<TiknasDictionaryBasedStringLocalizer>();
    }

    [Fact]
    public void TiknasStringLocalizerExtensions_GetInternalLocalizer_Using_LocalizerFactory()
    {
