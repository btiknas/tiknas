...
public class TiknasAutoMapperModule_Specific_ObjectMapper_Tests : TiknasIntegratedTest<AutoMapperTestModule>
{
    private readonly IObjectMapper _objectMapper;

    public TiknasAutoMapperModule_Specific_ObjectMapper_Tests()
    {
