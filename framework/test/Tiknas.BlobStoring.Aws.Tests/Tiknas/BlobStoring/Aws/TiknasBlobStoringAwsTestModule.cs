...
/// </summary>
[DependsOn(
    typeof(TiknasBlobStoringAwsModule),
    typeof(TiknasBlobStoringTestModule)
)]
public class TiknasBlobStoringAwsTestCommonModule : TiknasModule
{
}

[DependsOn(
    typeof(TiknasBlobStoringAwsTestCommonModule)
)]
public class TiknasBlobStoringAwsTestModule : TiknasModule
{
    private const string UserSecretsId = "9f0d2c00-80c1-435b-bfab-2c39c8249091";

    private readonly string _randomContainerName = "tiknas-aws-test-container-" + Guid.NewGuid().ToString("N");
