...
using NSubstitute;
using Shouldly;
using Tiknas.AspNetCore.Mvc.UI.Theme.Shared.Toolbars;
using Tiknas.AspNetCore.Mvc.UI.Theming;
using Tiknas.Authorization.Permissions;
using Tiknas.Security.Claims;
using Xunit;

namespace Tiknas.AspNetCore.Mvc.UI.Theme.Shared.Tests.Tiknas.AspNetCore.Mvc.UI.Theme.Shared.Toolbars;

public class Toolbar_Tests : TiknasAspNetCoreMvcUiThemeSharedTestBase
{
    protected override void ConfigureServices(IServiceCollection services)
    {
        services.Configure<TiknasToolbarOptions>(options =>
        {
    ...
    [Fact]
    public void TiknasToolbarOptions_Should_Contain_Contributors()
    {
        var options = GetRequiredService<IOptions<TiknasToolbarOptions>>().Value;
    ...
    public class MyComponent1 : TiknasViewComponent
    {
    ...
    public class MyComponent2 : TiknasViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
    ...
    public class MyComponent3 : TiknasViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
    ...
    public class MyComponent4 : TiknasViewComponent
    {
        public IViewComponentResult InvokeAsync()
        {
