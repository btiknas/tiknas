...
namespace Tiknas.AspNetCore.Mvc.DependencyInjection;

public class TiknasAspNetCoreMvcConventionalRegistrar_Tests
{
    [Fact]
    public void Should_Registered_Mvc_Service()
    {
        ...
        services.AddConventionalRegistrar(new TiknasAspNetCoreMvcConventionalRegistrar());
