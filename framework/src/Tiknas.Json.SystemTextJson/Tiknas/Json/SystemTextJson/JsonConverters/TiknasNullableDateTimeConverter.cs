...
public class TiknasNullableDateTimeConverter : JsonConverter<DateTime?>, ITransientDependency
{
    private readonly IClock _clock;
    private readonly TiknasJsonOptions _options;

    public TiknasNullableDateTimeConverter(IClock clock, IOptions<TiknasJsonOptions> tiknasJsonOptions)
    {
        _clock = clock;
