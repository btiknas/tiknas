...
public abstract class TiknasWebApplicationFactoryIntegratedTest<TProgram> : WebApplicationFactory<TProgram>
    where TProgram : class
{
    ...
    protected TiknasWebApplicationFactoryIntegratedTest()
    {
