...
/// </typeparam>
[Obsolete("Use TiknasWebApplicationFactoryIntegratedTest instead.")]
public abstract class TiknasAspNetCoreIntegratedTestBase<TStartupModule> : TiknasTestBaseWithServiceProvider, IDisposable
    where TStartupModule : class
{
    ...
    protected TiknasAspNetCoreIntegratedTestBase()
    {
    ...
    protected virtual IHostBuilder CreateHostBuilder()
    {
        return Host.CreateDefaultBuilder()
            ...
            {
                if (typeof(TStartupModule).IsAssignableTo<ITiknasModule>())
                {
                ...
                webBuilder.UseTiknasTestServer();
            })
            .UseAutofac()
