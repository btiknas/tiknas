...
public class MultiTenancyMiddleware : TiknasMiddlewareBase, ITransientDependency
{
    ...
    public async override Task InvokeAsync(HttpContext context, RequestDelegate next)
    {
        ...
        if (tenant?.Id != _currentTenant.Id)
        {
            using (_currentTenant.Change(tenant?.Id, tenant?.Name))
            {
                ...
                {
                    TiknasMultiTenancyCookieHelper.SetTenantCookie(context, _currentTenant.Id, _options.TenantKey);
                }
                ...
                if (requestCulture != null)
                {
                    ...
                    context.Items[TiknasRequestLocalizationMiddleware.HttpContextItemName] = true;
                }
