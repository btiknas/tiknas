...
public class TiknasAspNetCoreMultiTenancyOptions
{
    /// <summary>
    ...
    public TiknasAspNetCoreMultiTenancyOptions()
    {
        ...
        MultiTenancyMiddlewareErrorPageBuilder = async (context, exception) =>
        {
            ...
            if (tenantResolveResult != null)
            {
                ...
                var options = context.RequestServices.GetRequiredService<IOptions<TiknasAspNetCoreMultiTenancyOptions>>().Value;
                    ...
                    context.Request.Cookies.ContainsKey(options.TenantKey))
                {
                    ...
                    TiknasMultiTenancyCookieHelper.SetTenantCookie(context, null, options.TenantKey);
                }
            }
