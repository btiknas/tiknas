...
public class TenantResolver : ITenantResolver, ITransientDependency
{
    ...
    private readonly TiknasTenantResolveOptions _options;

    public TenantResolver(IOptions<TiknasTenantResolveOptions> options, IServiceProvider serviceProvider)
    {
