...
public class TenantConfigurationProvider : ITenantConfigurationProvider, ITransientDependency
{
    ...
    protected virtual IStringLocalizer<TiknasMultiTenancyResource> StringLocalizer { get; }

    public TenantConfigurationProvider(
        ITenantResolver tenantResolver,
        ITenantStore tenantStore,
        ITenantResolveResultAccessor tenantResolveResultAccessor,
        IStringLocalizer<TiknasMultiTenancyResource> stringLocalizer,
        ...
        if (resolveResult.TenantIdOrName != null)
        {
            ...
            if (tenant == null)
            {
                throw new BusinessException(
                    code: "TiknasIo.MultiTenancy:010001",
            ...
            {
                throw new BusinessException(
                    code: "TiknasIo.MultiTenancy:010002",
