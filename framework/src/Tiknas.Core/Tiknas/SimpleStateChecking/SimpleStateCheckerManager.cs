    ...
    where TState : IHasSimpleStateCheckers<TState>
{
    ...
    protected TiknasSimpleStateCheckerOptions<TState> Options { get; }

    public SimpleStateCheckerManager(IServiceProvider serviceProvider, IOptions<TiknasSimpleStateCheckerOptions<TState>> options)
    {
