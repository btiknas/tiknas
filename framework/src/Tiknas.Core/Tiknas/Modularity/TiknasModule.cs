...
public abstract class TiknasModule :
    ITiknasModule,
    ...
    IPostConfigureServices
{
    ...
    protected internal ServiceConfigurationContext ServiceConfigurationContext {
        get {
            ...
            {
                throw new TiknasException($"{nameof(ServiceConfigurationContext)} is only available in the {nameof(ConfigureServices)}, {nameof(PreConfigureServices)} and {nameof(PostConfigureServices)} methods.");
            }
    ...
    public static bool IsTiknasModule(Type type)
    {
        ...
        return
            ...
            typeof(ITiknasModule).GetTypeInfo().IsAssignableFrom(type);
    }

    internal static void CheckTiknasModuleType(Type moduleType)
    {
        if (!IsTiknasModule(moduleType))
        {
            throw new ArgumentException("Given type is not an Tiknas module: " + moduleType.AssemblyQualifiedName);
        }
    }
