...
public class TiknasDictionaryBasedStringLocalizer : ITiknasStringLocalizer
{
    public LocalizationResourceBase Resource { get; }

    public List<IStringLocalizer> BaseLocalizers { get; }

    public TiknasLocalizationOptions TiknasLocalizationOptions { get; }
    ...
    public TiknasDictionaryBasedStringLocalizer(
        LocalizationResourceBase resource,
        List<IStringLocalizer> baseLocalizers,
        TiknasLocalizationOptions tiknasLocalizationOptions)
    {
        Resource = resource;
        ...
        bool tryDefaults = true)
    {
        ...
        if (TiknasLocalizationOptions.TryToGetFromBaseCulture)
        {
        ...
        if (TiknasLocalizationOptions.TryToGetFromDefaultCulture)
        {
    ...
    public class CultureWrapperStringLocalizer : ITiknasStringLocalizer
    {
        private readonly string _cultureName;
        private readonly TiknasDictionaryBasedStringLocalizer _innerLocalizer;
        ...
        public CultureWrapperStringLocalizer(string cultureName, TiknasDictionaryBasedStringLocalizer innerLocalizer)
        {
