    ...
    where TMongoDbContext : ITiknasMongoDbContext
{
    ...
    protected readonly TiknasMongoDbContextOptions Options;
    ...
    public UnitOfWorkMongoDbContextProvider(
        ...
        IOptions<TiknasMongoDbContextOptions> options,
    ...
    private TMongoDbContext CreateDbContext(IUnitOfWork unitOfWork, MongoUrl mongoUrl, string databaseName)
    {
        ...
        dbContext.ToTiknasMongoDbContext().InitializeDatabase(database, client, null);
        ...
        IMongoDatabase database)
    {
        ...
        if (activeTransaction?.SessionHandle == null)
        {
            ...
            dbContext.ToTiknasMongoDbContext().InitializeDatabase(database, client, session);
        }
        else
        {
            dbContext.ToTiknasMongoDbContext().InitializeDatabase(database, client, activeTransaction.SessionHandle);
        }
