...
public class TiknasMongoDbDateTimeSerializer : DateTimeSerializer
{
    protected DateTimeKind DateTimeKind { get; set; }
    protected bool DisableDateTimeNormalization { get; set; }

    public TiknasMongoDbDateTimeSerializer(DateTimeKind dateTimeKind, bool disableDateTimeNormalization)
    {
