...
/// </summary>
public class TiknasAutofacServiceProviderFactory : IServiceProviderFactory<ContainerBuilder>
{
    private readonly ContainerBuilder _builder;
    private IServiceCollection _services = default!;

    public TiknasAutofacServiceProviderFactory(ContainerBuilder builder)
    {
        _builder = builder;
    }
