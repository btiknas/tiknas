...
public class UnitOfWork : IUnitOfWork, ITransientDependency
{
    ...
    public const string UnitOfWorkReservationName = "_TiknasActionUnitOfWork";

    public Guid Id { get; } = Guid.NewGuid();

    public ITiknasUnitOfWorkOptions Options { get; private set; } = default!;
    ...
    private readonly TiknasUnitOfWorkDefaultOptions _defaultOptions;
    ...
    public virtual void Initialize(TiknasUnitOfWorkOptions options)
    {
        Check.NotNull(options, nameof(options));

        if (Options != null)
        {
            throw new TiknasException("This unit of work has already been initialized.");
        }
    ...
    public virtual void AddDatabaseApi(string key, IDatabaseApi api)
    {
        ...
        {
            throw new TiknasException("This unit of work already contains a database API for the given key.");
        }
    ...
    public virtual void AddTransactionApi(string key, ITransactionApi api)
    {
        ...
        {
            throw new TiknasException("This unit of work already contains a transaction API for the given key.");
        }
    ...
    private void PreventMultipleComplete()
    {
        ...
        {
            throw new TiknasException("Completion has already been requested for this unit of work.");
        }
    }
