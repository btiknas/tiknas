...
public abstract class TiknasPageModel : PageModel
{
    ...
    protected virtual IStringLocalizer CreateLocalizer()
    {
        ...
        if (localizer == null)
        {
            throw new TiknasException($"Set {nameof(LocalizationResourceType)} or define the default localization resource type (by configuring the {nameof(TiknasLocalizationOptions)}.{nameof(TiknasLocalizationOptions.DefaultResourceType)}) to be able to use the {nameof(L)} object!");
        }
