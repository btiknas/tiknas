...
namespace Dapr
{
    ...
    /// </summary>
    public class TiknasSubscribeOptions
    {
        /// <summary>
        ...
        /// </summary>
        public Func<List<TiknasSubscription>, Task>? SubscriptionsCallback { get; set; }
    }

    /// <summary>
    /// This class defines subscribe endpoint response
    /// </summary>
    public class TiknasSubscription
    {
        /// <summary>
        ...
        /// </summary>
        public TiknasRoutes? Routes { get; set; }

        /// <summary>
        /// Gets or sets the metadata.
        /// </summary>
        public TiknasMetadata? Metadata { get; set; }
    ...
    /// </summary>
    public class TiknasMetadata : Dictionary<string, string>
    {
        /// <summary>
        /// Initializes a new instance of the Metadata class.
        /// </summary>
        public TiknasMetadata() { }

        /// <summary>
        /// Initializes a new instance of the Metadata class.
        /// </summary>
        /// <param name="dictionary"></param>
        public TiknasMetadata(IDictionary<string, string> dictionary) : base(dictionary) { }
    ...
    public class TiknasRoutes
    {
        ...
        /// </summary>
        public List<TiknasRule>? Rules { get; set; }
    }

    /// <summary>
    /// This class defines the rule for subscribe endpoint.
    /// </summary>
    public class TiknasRule
    {
        /// <summary>
...
namespace Microsoft.AspNetCore.Builder
{
    ...
    /// </summary>
    public static class TiknasDaprEndpointRouteBuilderExtensions
    {
        /// <summary>
        ...
        public static IEndpointConventionBuilder MapTiknasSubscribeHandler(this IEndpointRouteBuilder endpoints)
        {
        ...
        /// <returns>The <see cref="IEndpointConventionBuilder" />.</returns>
        /// <seealso cref="MapTiknasSubscribeHandler(IEndpointRouteBuilder)"/>
        public static IEndpointConventionBuilder MapTiknasSubscribeHandler(this IEndpointRouteBuilder endpoints, TiknasSubscribeOptions options)
        {
            return CreateSubscribeEndPoint(endpoints, options);
        }

        private static IEndpointConventionBuilder CreateSubscribeEndPoint(IEndpointRouteBuilder endpoints, TiknasSubscribeOptions? options = null)
        {
            ...
            return endpoints.MapGet("dapr/subscribe", async context =>
            {
                ...
                var subscriptions = dataSource.Endpoints
                    ...
                    .Select(e =>
                    {
                        ...
                        var metadata = new TiknasMetadata(e.SelectMany(c => c.OriginalTopicMetadata).GroupBy(c => c.Key).ToDictionary(c => c.Key, c => string.Join(metadataSeparator, c.SelectMany(c => c.Value).Distinct())));
                        if (rawPayload || options?.EnableRawPayload is true)
                        {
                            metadata.Add(TiknasMetadata.RawPayload, "true");
                        }
                        ...
                        if (rules.Count > 0)
                        {
                            subscription.Routes = new TiknasRoutes
                            {
                                Rules = rules.Select(e => new TiknasRule
                                {
                                    Match = e.Match,
