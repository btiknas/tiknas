...
public class ApplicationLocalizationConfigurationDto
{
    ...
    /// (by TiknasApplicationConfigurationAppService). However, it is here to be filled
    /// using the application localization endpoint (TiknasApplicationLocalizationAppService).
