...
{
    public const string JobDataPrefix = "Tiknas";
    public const string RetryIndex = "RetryIndex";

    protected IScheduler Scheduler { get; }

    protected TiknasBackgroundJobQuartzOptions Options { get; }

    protected IJsonSerializer JsonSerializer { get; }

    public QuartzBackgroundJobManager(IScheduler scheduler, IOptions<TiknasBackgroundJobQuartzOptions> options, IJsonSerializer jsonSerializer)
    {
        Scheduler = scheduler;
