...
{
    private const string UnitOfWorkEventRecordEntityPropName = "_Tiknas_Entity";
    ...
    protected TiknasDistributedEntityEventOptions DistributedEntityEventOptions { get; }

    public EntityChangeEventHelper(
        IUnitOfWorkManager unitOfWorkManager,
        IEntityToEtoMapper entityToEtoMapper,
        IOptions<TiknasDistributedEntityEventOptions> distributedEntityEventOptions)
    {
