...
namespace Tiknas.Domain.Entities.Auditing;

/// <summary>
/// This class can be used to simplify implementing <see cref="T:Tiknas.Auditing.ICreationAuditedObject" /> for an entity.
/// </summary>
[Serializable]
