...
public class RazorTemplateRenderingEngine : TemplateRenderingEngineBase, ITransientDependency
{
        ...
        object? model = null)
    {
        ...
        {
            var compiledViewProvider = scope.ServiceProvider.GetRequiredService<ITiknasCompiledViewProvider>();
            var assembly = await compiledViewProvider.GetAssemblyAsync(templateDefinition);
            var templateType = assembly.GetType(TiknasRazorTemplateConsts.TypeName)!;
