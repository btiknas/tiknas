...
public class TiknasRazorTemplateCSharpCompiler : ISingletonDependency
{
    protected TiknasRazorTemplateCSharpCompilerOptions Options { get; }

    public TiknasRazorTemplateCSharpCompiler(IOptions<TiknasRazorTemplateCSharpCompilerOptions> options)
    {
    ...
    private static IEnumerable<PortableExecutableReference> DefaultReferences => new List<Assembly>()
            {
                ...
                typeof(TiknasRazorTemplateCSharpCompiler).Assembly
            }
