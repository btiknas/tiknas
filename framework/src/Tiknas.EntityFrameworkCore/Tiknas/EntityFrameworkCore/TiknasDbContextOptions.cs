...
public class TiknasDbContextOptions
{
    internal List<Action<TiknasDbContextConfigurationContext>> DefaultPreConfigureActions { get; }

    internal Action<TiknasDbContextConfigurationContext>? DefaultConfigureAction { get; set; }
    ...
    public TiknasDbContextOptions()
    {
        DefaultPreConfigureActions = new List<Action<TiknasDbContextConfigurationContext>>();
    ...
    public void PreConfigure([NotNull] Action<TiknasDbContextConfigurationContext> action)
    {
    ...
    public void Configure([NotNull] Action<TiknasDbContextConfigurationContext> action)
    {
        Check.NotNull(action, nameof(action));
    ...
    public void PreConfigure<TDbContext>([NotNull] Action<TiknasDbContextConfigurationContext<TDbContext>> action)
        where TDbContext : TiknasDbContext<TDbContext>
    {
        Check.NotNull(action, nameof(action));
    ...
    public void Configure<TDbContext>([NotNull] Action<TiknasDbContextConfigurationContext<TDbContext>> action)
        where TDbContext : TiknasDbContext<TDbContext>
    {
        Check.NotNull(action, nameof(action));
