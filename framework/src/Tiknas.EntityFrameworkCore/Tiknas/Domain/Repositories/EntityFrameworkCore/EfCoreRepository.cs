    ...
    where TEntity : class, IEntity
{
    ...
    protected virtual TiknasEntityOptions<TEntity> TiknasEntityOptions => _entityOptionsLazy.Value;

    private readonly IDbContextProvider<TDbContext> _dbContextProvider;
    private readonly Lazy<TiknasEntityOptions<TEntity>> _entityOptionsLazy;
    ...
    public EfCoreRepository(IDbContextProvider<TDbContext> dbContextProvider)
    {
        ...
        _entityOptionsLazy = new Lazy<TiknasEntityOptions<TEntity>>(
            () => ServiceProvider
                      .GetRequiredService<IOptions<TiknasEntityOptions>>()
                      .Value
                      .GetOrNull<TEntity>() ?? TiknasEntityOptions<TEntity>.Empty
        );
    }
    ...
    {
        if (TiknasEntityOptions.DefaultWithDetailsFunc == null)
        {
            return base.WithDetails();
        }

        return TiknasEntityOptions.DefaultWithDetailsFunc(GetQueryable());
    }
    ...
    public async override Task<IQueryable<TEntity>> WithDetailsAsync()
    {
        ...
        return TiknasEntityOptions.DefaultWithDetailsFunc(await GetQueryableAsync());
    }
