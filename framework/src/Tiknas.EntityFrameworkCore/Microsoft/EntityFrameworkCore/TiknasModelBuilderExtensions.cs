...
public static class TiknasModelBuilderExtensions
{
    private const string ModelDatabaseProviderAnnotationKey = "_Tiknas_DatabaseProvider";
    private const string ModelMultiTenancySideAnnotationKey = "_Tiknas_MultiTenancySide";
