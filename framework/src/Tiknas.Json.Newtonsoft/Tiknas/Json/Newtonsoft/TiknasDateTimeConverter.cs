...
public class TiknasDateTimeConverter : DateTimeConverterBase, ITransientDependency
{
    ...
    public TiknasDateTimeConverter(IClock clock, IOptions<TiknasJsonOptions> options)
    {
        _clock = clock;
