...
{
    protected TiknasKafkaEventBusOptions TiknasKafkaEventBusOptions { get; }
    ...
    public KafkaDistributedEventBus(
        ...
        IOptions<TiknasKafkaEventBusOptions> tiknasKafkaEventBusOptions,
        IKafkaMessageConsumerFactory messageConsumerFactory,
        IOptions<TiknasDistributedEventBusOptions> tiknasDistributedEventBusOptions,
        ...
        : base(
            ...
            currentTenant,
            unitOfWorkManager,
            tiknasDistributedEventBusOptions,
            guidGenerator,
            clock,
            eventHandlerInvoker,
            localEventBus,
    ...
    {
        TiknasKafkaEventBusOptions = tiknasKafkaEventBusOptions.Value;
    ...
    public void Initialize()
    {
        Consumer = MessageConsumerFactory.Create(
            TiknasKafkaEventBusOptions.TopicName,
            TiknasKafkaEventBusOptions.GroupId,
            TiknasKafkaEventBusOptions.ConnectionName);
    ...
    {
        var producer = ProducerPool.Get(TiknasKafkaEventBusOptions.ConnectionName);
