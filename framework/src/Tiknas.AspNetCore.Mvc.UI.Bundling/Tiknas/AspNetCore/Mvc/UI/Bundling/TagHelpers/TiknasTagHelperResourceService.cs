...
public abstract class TiknasTagHelperResourceService : ITransientDependency
{
    public ILogger<TiknasTagHelperResourceService> Logger { get; set; }
    protected IBundleManager BundleManager { get; }
    protected IWebHostEnvironment HostingEnvironment { get; }
    protected TiknasBundlingOptions Options { get; }

    protected TiknasTagHelperResourceService(
        ...
        IWebHostEnvironment hostingEnvironment)
    {
        ...
        Logger = NullLogger<TiknasTagHelperResourceService>.Instance;
    }
