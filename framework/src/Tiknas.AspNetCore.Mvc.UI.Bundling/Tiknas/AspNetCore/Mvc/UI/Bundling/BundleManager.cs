...
using Tiknas.AspNetCore.Mvc.UI.Bundling.Scripts;
using Tiknas.AspNetCore.Mvc.UI.Bundling.Styles;
using Tiknas.AspNetCore.Mvc.UI.Resources;
...
public class BundleManager : IBundleManager, ITransientDependency
{
    ...
    protected readonly TiknasBundlingOptions Options;
    protected readonly TiknasBundleContributorOptions ContributorOptions;
    ...
    public BundleManager(
        ...
        IOptions<TiknasBundleContributorOptions> contributorOptions,
    ...
    protected virtual bool IsBundlingEnabled()
    {
        switch (Options.Mode)
        {
            ...
            default:
                throw new TiknasException($"Unhandled {nameof(BundlingMode)}: {Options.Mode}");
        }
    }
