...
public class OpenIdLocalUserCreationClientOptions
{
    ...
    /// <summary>
    /// Default value: "TiknasIdentity".
    /// Fallbacks to the "Default" remote service configuration, if "TiknasIdentity" configuration is not available.
    ...
    /// </summary>
    public string RemoteServiceName { get; set; } = "TiknasIdentity";
