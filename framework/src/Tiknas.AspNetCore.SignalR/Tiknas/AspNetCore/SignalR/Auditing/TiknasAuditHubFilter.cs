...
namespace Tiknas.AspNetCore.SignalR.Auditing;

public class TiknasAuditHubFilter : IHubFilter
{
    ...
    {
        var options = invocationContext.ServiceProvider.GetRequiredService<IOptions<TiknasAuditingOptions>>().Value;
    ...
    {
        var options = serviceProvider.GetRequiredService<IOptions<TiknasAuditingOptions>>().Value;
