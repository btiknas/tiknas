...
public class DaprDistributedEventBus : DistributedEventBusBase, ISingletonDependency
{
    ...
    protected TiknasDaprEventBusOptions DaprEventBusOptions { get; }
    ...
    public DaprDistributedEventBus(
        ...
        IOptions<TiknasDaprEventBusOptions> daprEventBusOptions,
    ...
    protected virtual async Task PublishToDaprAsync(string eventName, object eventData, Guid? messageId = null, string? correlationId = null)
    {
        ...
        var data = new TiknasDaprEventData(DaprEventBusOptions.PubSubName, eventName, (messageId ?? GuidGenerator.Create()).ToString("N"), Serializer.SerializeToString(eventData), correlationId);
