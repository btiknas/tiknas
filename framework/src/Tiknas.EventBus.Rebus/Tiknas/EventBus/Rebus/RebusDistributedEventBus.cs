...
public class RebusDistributedEventBus : DistributedEventBusBase, ISingletonDependency
{
    ...
    protected TiknasRebusEventBusOptions TiknasRebusEventBusOptions { get; }
    ...
    public RebusDistributedEventBus(
        ...
        IOptions<TiknasRebusEventBusOptions> tiknasEventBusRebusOptions,
            ...
            correlationIdProvider)
    {
        ...
        TiknasRebusEventBusOptions = tiknasEventBusRebusOptions.Value;
    ...
    {
        if (TiknasRebusEventBusOptions.Publish != null)
        {
            await TiknasRebusEventBusOptions.Publish(Rebus, eventType, eventData);
            return;
        }
