...
public class TemplateDefinition : IHasNameWithLocalizableDisplayName
{
    ...
    /// <returns>
    /// Returns the value in the <see cref="Properties"/> dictionary by given <c>name</c>.
    /// Returns null if given <c>name</c> is not present in the <see cref="Properties"/> dictionary.
    /// </returns>
