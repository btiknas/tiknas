...
public class TiknasTemplateRenderer : ITemplateRenderer, ITransientDependency
{
    protected IServiceScopeFactory ServiceScopeFactory { get; }
    protected ITemplateDefinitionManager TemplateDefinitionManager { get; }
    protected TiknasTextTemplatingOptions Options { get; }

    public TiknasTemplateRenderer(
        ...
        Dictionary<string, object>? globalContext = null)
    {
        ...
        throw new TiknasException("There is no rendering engine found with template name: " + templateName);
    }
}
