...
//TODO: Create a Tiknas.Data.Filtering namespace?
    ...
    where TFilter : class
{
    ...
    private readonly TiknasDataFilterOptions _options;

    private readonly AsyncLocal<DataFilterState> _filter;

    public DataFilter(IOptions<TiknasDataFilterOptions> options)
    {
