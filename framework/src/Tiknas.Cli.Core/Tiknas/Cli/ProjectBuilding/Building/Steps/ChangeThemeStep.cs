...
public class ChangeThemeStep : ProjectBuildPipelineStep
{
    ...
    private static void ChangeThemeToBasicForBlazorProjects(ProjectBuildContext context, string defaultThemeName)
    {
        ReplacePackageReferenceWithProjectReference(
            ...
            $"Tiknas.AspNetCore.Components.WebAssembly.{defaultThemeName}Theme",
            @"..\..\..\..\..\modules\basic-theme\src\Tiknas.AspNetCore.Components.WebAssembly.BasicTheme\Tiknas.AspNetCore.Components.WebAssembly.BasicTheme.csproj"
        );
        ...
        ReplacePackageReferenceWithProjectReference(
            ...
            $"Tiknas.AspNetCore.Mvc.UI.Theme.{defaultThemeName}",
            @"..\..\..\..\..\modules\basic-theme\src\Tiknas.AspNetCore.Mvc.UI.Theme.Basic\Tiknas.AspNetCore.Mvc.UI.Theme.Basic.csproj"
        );
    ...
    private static void ChangeThemeToLeptonForBlazorProjects(ProjectBuildContext context)
    {
        ReplacePackageReferenceWithProjectReference(
            ...
            "Tiknas.AspNetCore.Components.WebAssembly.LeptonXTheme",
            @"..\..\..\..\..\lepton-theme\src\Tiknas.AspNetCore.Components.WebAssembly.LeptonTheme\Tiknas.AspNetCore.Components.WebAssembly.LeptonTheme.csproj"
        );
        ...
        ReplacePackageReferenceWithProjectReference(
            ...
            "Tiknas.AspNetCore.Mvc.UI.Theme.LeptonX",
            @"..\..\..\..\..\lepton-theme\src\Tiknas.AspNetCore.Mvc.UI.Theme.Lepton\Tiknas.AspNetCore.Mvc.UI.Theme.Lepton.csproj"
        );
    ...
    private static void ConfigureLeptonManagementPackagesForNoLayersMvc(ProjectBuildContext context, string targetProjectPath, IEnumerable<string> projectNames)
    {
        ...
        foreach (var projectName in projectNames)
        {
            ...
            AddProjectReference(file, $@"..\..\..\..\lepton-theme\src\Tiknas.LeptonTheme.Management.{projectName}\Tiknas.LeptonTheme.Management.{projectName}.csproj");
    ...
    private static void ChangeThemeToLeptonForMvcProjects(ProjectBuildContext context)
    {
        ...
        foreach (var projectName in projectNames)
        {
            ...
            RemoveLinesByStatement(
                context,
                moduleFile.Name,
                "Tiknas.LeptonX.Shared;"
            );

            AddNamespaces(
                context,
                moduleFile.Name,
                "using Tiknas.AspNetCore.Mvc.UI.Theme.Lepton;",
                "using Tiknas.AspNetCore.Mvc.UI.Theme.Lepton.Bundling;"
            );
        }
    }
    ...
    {
        var reference = $@"..\..\..\..\..\lepton-theme\src\Tiknas.LeptonTheme.Management.{projectInfo.Key}\Tiknas.LeptonTheme.Management.{projectInfo.Key}.csproj";
    ...
    private static void AddModuleDependency(FileEntry moduleFile, string projectName, string dependency, bool underManagementFolder = true)
    {
        ...
        for (var i = 0; i < lines.Length; i++)
        {
            ...
            {
                lines[i - 1] = lines[i - 1] + ("using Tiknas.LeptonTheme" + (underManagementFolder ? ".Management." : ".") + (projectNames.Any(p => p == projectName) ? projectName : "")).TrimEnd('.').EnsureEndsWith(';') + Environment.NewLine;
            }
    ...
    private static void ChangeThemeToBasicForMvcProjects(ProjectBuildContext context, string defaultThemeName)
    {
        ...
        foreach (var projectName in projectNames)
        {
            ...
            AddNamespaces(
                context,
                moduleFile.Name,
                "using Tiknas.AspNetCore.Mvc.UI.Theme.Basic;",
                "using Tiknas.AspNetCore.Mvc.UI.Theme.Basic.Bundling;"
            );
        }
    }
    ...
    private static void ChangeThemeToBasicForBlazorServerProjects(ProjectBuildContext context, string defaultThemeName)
    {
        ...
        foreach (var project in projects)
        {
            ReplacePackageReferenceWithProjectReference(
                ...
                $"Tiknas.AspNetCore.Components.Server.{defaultThemeName}",
                @"..\..\..\..\..\modules\basic-theme\src\Tiknas.AspNetCore.Components.Server.BasicTheme\Tiknas.AspNetCore.Components.Server.BasicTheme.csproj"
            );
    ...
    private static void ChangeThemeToLeptonForBlazorServerProjects(ProjectBuildContext context)
    {
        ...
        foreach (var projectName in projectNames)
        {
            ...
            ReplacePackageReferenceWithProjectReference(
                context,
                $"/MyCompanyName.MyProjectName.{projectName}/MyCompanyName.MyProjectName.{projectName}.csproj",
                "Tiknas.AspNetCore.Components.Server.LeptonXTheme",
                @"..\..\..\..\..\lepton-theme\src\Tiknas.AspNetCore.Components.Server.LeptonTheme\Tiknas.AspNetCore.Components.Server.LeptonTheme.csproj"
            );
    ...
    private static void ChangeThemeToLeptonForMauiBlazorProjects(ProjectBuildContext context)
    {
        ReplacePackageReferenceWithProjectReference(
            ...
            "Tiknas.AspNetCore.Components.MauiBlazor.LeptonXTheme",
            @"..\..\..\..\..\lepton-theme\src\Tiknas.AspNetCore.Components.MauiBlazor.LeptonTheme\Tiknas.AspNetCore.Components.MauiBlazor.LeptonTheme.csproj"
        );

        ReplaceAllKeywords(
            context,
            "/MyCompanyName.MyProjectName.MauiBlazor/MainPage.xaml",
            "clr-namespace:Tiknas.AspNetCore.Components.Web.LeptonXTheme.Components;assembly=Tiknas.AspNetCore.Components.Web.LeptonXTheme",
            "clr-namespace:Tiknas.AspNetCore.Components.Web.LeptonTheme.Components;assembly=Tiknas.AspNetCore.Components.Web.LeptonTheme");
        ...
        ReplaceAllKeywords(
            ...
            "Tiknas.AspNetCore.Components.MauiBlazor.LeptonXTheme.Components.AccountLayout",
            "Tiknas.AspNetCore.Components.MauiBlazor.LeptonTheme.Components.AccountLayout");
        ...
        ReplaceAllKeywords(
            context,
            "/MyCompanyName.MyProjectName.MauiBlazor/Pages/Account/RedirectToLogout.razor",
            "Tiknas.LeptonX.Shared.Localization",
            "Tiknas.LeptonTheme.Management.Localization");
