...
public class CmdHelper : ICmdHelper, ITransientDependency
{
    ...
    protected TiknasCliOptions CliOptions { get; }

    public CmdHelper(IOptionsSnapshot<TiknasCliOptions> cliOptions)
    {
    ...
    public string GetFileName()
    {
        ...
        throw new TiknasException($"Cannot determine shell command for this OS! " +
