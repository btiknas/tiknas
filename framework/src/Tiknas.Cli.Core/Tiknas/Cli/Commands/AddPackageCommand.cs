...
public class AddPackageCommand : IConsoleCommand, ITransientDependency
{
    ...
    public string GetUsageInfo()
    {
        ...
        sb.AppendLine("");
        sb.AppendLine("'add-package' command is used to add an TIKNAS package to a project.");
        sb.AppendLine("It should be used in a folder containing a .csproj file, .sln file or angular.json.");
        sb.AppendLine("");
        sb.AppendLine("Usage:");
        sb.AppendLine("");
        sb.AppendLine("  tiknas add-package <package-name> [options]");
        sb.AppendLine("");
        ...
        sb.AppendLine("  -v|--version <version>                                Specifies the version of the package. Default is your project's TIKNAS version or latest TIKNAS version.");
        sb.AppendLine("");
        sb.AppendLine("Examples:");
        sb.AppendLine("");
        sb.AppendLine("  tiknas add-package Tiknas.FluentValidation                                  Adds the NuGet package to the current project.");
    ...
    {
        return "Add a new TIKNAS package to a project by adding related NuGet package dependencies and [DependsOn(...)] attributes.";
    }
