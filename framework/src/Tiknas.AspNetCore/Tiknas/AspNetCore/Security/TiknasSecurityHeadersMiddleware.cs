...
public class TiknasSecurityHeadersMiddleware : TiknasMiddlewareBase, ITransientDependency
{
    public IOptions<TiknasSecurityHeadersOptions> Options { get; set; }
    ...
    public TiknasSecurityHeadersMiddleware(IOptions<TiknasSecurityHeadersOptions> options)
    {
        Options = options;
    }
    ...
    public async override Task InvokeAsync(HttpContext context, RequestDelegate next)
    {
        ...
        if (endpoint?.Metadata.GetMetadata<IgnoreTiknasSecurityHeaderAttribute>() != null)
        {
        ...
        if (Options.Value.UseContentSecurityPolicyScriptNonce)
        {
            ...
            context.Items.Add(TiknasAspNetCoreConsts.ScriptNonceKey, randomValue);
        }
    ...
    protected virtual string BuildContentSecurityPolicyValue(HttpContext context)
    {
        ...
        if (!(Options.Value.UseContentSecurityPolicyScriptNonce &&
              context.Items.TryGetValue(TiknasAspNetCoreConsts.ScriptNonceKey, out var nonce) &&
