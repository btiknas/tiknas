...
{
    protected TiknasAzureEventBusOptions Options { get; }
    ...
    public AzureDistributedEventBus(
        ...
        IClock clock,
        IOptions<TiknasAzureEventBusOptions> tiknasAzureEventBusOptions,
    ...
    {
        Options = tiknasAzureEventBusOptions.Value;
        ...
        foreach (var outgoingEvent in outgoingEventArray)
        {
            ...
            if (!messageBatch.TryAddMessage(message))
            {
                throw new TiknasException(
                    "The message is too large to fit in the batch. Set TiknasEventBusBoxesOptions.OutboxWaitingEventMaxCount to reduce the number");
            }
