...
using Tiknas.Http.Client.StaticProxying;
...
public class TiknasHttpClientProxyServiceConvention : TiknasServiceConvention
{
    ...
    protected readonly TiknasHttpClientStaticProxyingOptions StaticProxyingOptions;

    public TiknasHttpClientProxyServiceConvention(
        IOptions<TiknasAspNetCoreMvcOptions> options,
        IConventionalRouteBuilder conventionalRouteBuilder,
        IClientProxyApiDescriptionFinder clientProxyApiDescriptionFinder,
        IOptions<TiknasHttpClientStaticProxyingOptions> staticProxyingOptions)
    ...
    {
        return application.Controllers.Where(c => !TiknasHttpClientProxyHelper.IsClientProxyService(c.ControllerType)).ToList();
    }
    ...
    protected virtual ActionApiDescriptionModel? FindActionApiDescriptionModel(ControllerModel controller, ActionModel action)
    {
        ...
        if (actionApiDescriptionModel.ImplementFrom!.StartsWith("Tiknas.Application.Services"))
        {
