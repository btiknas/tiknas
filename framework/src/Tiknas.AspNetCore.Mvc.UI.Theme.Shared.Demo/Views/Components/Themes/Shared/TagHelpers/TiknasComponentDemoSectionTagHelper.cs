...
namespace Tiknas.AspNetCore.Mvc.UI.Theme.Shared.Demo.Views.Components.Themes.Shared.TagHelpers;

public class TiknasComponentDemoSectionTagHelper : TiknasTagHelper
{
    private const string DemoSectionOpeningTag = "<tiknas-component-demo-section";
    private const string DemoSectionClosingTag = "</tiknas-component-demo-section";
    ...
    public TiknasComponentDemoSectionTagHelper(
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        output.PreContent.AppendHtml($"<div class=\"tab-pane fade show active\" id=\"nav-preview-{previewId}\" role=\"ttiknasanel\" aria-labelledby=\"nav-preview-tab-{previewId}\">");

        /* component rendering here */

        output.PostContent.AppendHtml("</div>"); // tab-pane
        output.PostContent.AppendHtml($"<div class=\"tab-pane fade\" id=\"nav-code-{codeBlockId}\" role=\"ttiknasanel\" aria-labelledby=\"nav-code-tab-{codeBlockId}\">");
        ...
        output.PostContent.AppendHtml($"<a class=\"nav-link active\" id=\"tag-helper-tab-{tagHelperCodeBlockId}\" data-bs-toggle=\"pill\" href=\"#tag-helper-{tagHelperCodeBlockId}\" role=\"tab\" aria-controls=\"tag-helper-{tagHelperCodeBlockId}\" aria-selected=\"true\">Tiknas Tag Helper</a>");
        ...
        output.PostContent.AppendHtml($"<div class=\"tab-pane fade show active\" id=\"tag-helper-{tagHelperCodeBlockId}\" role=\"ttiknasanel\" aria-labelledby=\"tag-helper-tab-{tagHelperCodeBlockId}\">");
        ...
        output.PostContent.AppendHtml($"<div class=\"tab-pane fade\" id=\"bootstrap-{bootstrapCodeBlockId}\" role=\"ttiknasanel\" aria-labelledby=\"bootstrap-tab-{bootstrapCodeBlockId}\">");
        output.PostContent.AppendHtml("<pre class=\"p-4\">");
        output.PostContent.AppendHtml("<code class=\"language-html\">");
    ...
    private string GetRawDemoSource()
    {
        ...
        throw new TiknasException($"Could not find {Title} demo section inside {ViewPath}");
    }
