...
/// </summary>
public class TiknasAsyncTimer : ITransientDependency
{
    /// <summary>
    /// This func is raised periodically according to Period of Timer.
    /// </summary>
    public Func<TiknasAsyncTimer, Task> Elapsed = _ => Task.CompletedTask;
    ...
    public ILogger<TiknasAsyncTimer> Logger { get; set; }
    ...
    public TiknasAsyncTimer()
    {
        ExceptionNotifier = NullExceptionNotifier.Instance;
        Logger = NullLogger<TiknasAsyncTimer>.Instance;
    ...
    public void Start(CancellationToken cancellationToken = default)
    {
        if (Period <= 0)
        {
            throw new TiknasException("Period should be set before starting the timer!");
        }
