...
using Tiknas.AspNetCore.Mvc.Utils;
...
public class AspNetCoreApiDescriptionModelProvider : IApiDescriptionModelProvider, ITransientDependency
{
    ...
    private readonly TiknasAspNetCoreMvcOptions _tiknasAspNetCoreMvcOptions;
    private readonly TiknasApiDescriptionModelOptions _modelOptions;

    public AspNetCoreApiDescriptionModelProvider(
        IOptions<AspNetCoreApiDescriptionModelProviderOptions> options,
        IApiDescriptionGroupCollectionProvider descriptionProvider,
        IOptions<TiknasAspNetCoreMvcOptions> tiknasAspNetCoreMvcOptions,
        IOptions<TiknasApiDescriptionModelOptions> modelOptions)
    {
        _options = options.Value;
        _descriptionProvider = descriptionProvider;
        _tiknasAspNetCoreMvcOptions = tiknasAspNetCoreMvcOptions.Value;
    ...
    {
        foreach (var controllerSetting in _tiknasAspNetCoreMvcOptions.ConventionalControllers.ConventionalControllerSettings)
        {
