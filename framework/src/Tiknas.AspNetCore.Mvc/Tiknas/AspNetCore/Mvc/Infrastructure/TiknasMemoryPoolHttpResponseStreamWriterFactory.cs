...
namespace Tiknas.AspNetCore.Mvc.Infrastructure;

/// <summary>
/// https://github.com/dotnet/aspnetcore/issues/40928#issuecomment-1450063613
/// </summary>
public class TiknasMemoryPoolHttpResponseStreamWriterFactory : IHttpResponseStreamWriterFactory
{
    ...
    public TiknasMemoryPoolHttpResponseStreamWriterFactory(ArrayPool<byte> bytePool, ArrayPool<char> charPool)
    {
