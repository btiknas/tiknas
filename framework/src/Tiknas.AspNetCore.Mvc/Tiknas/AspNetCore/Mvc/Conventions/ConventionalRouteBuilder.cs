...
{
    protected TiknasConventionalControllerOptions Options { get; }

    public ConventionalRouteBuilder(IOptions<TiknasConventionalControllerOptions> options)
    {
    ...
    protected virtual string GetApiRoutePrefix(ActionModel actionModel, ConventionalControllerSetting? configuration)
    {
        ...
        {
            return TiknasAspNetCoreConsts.DefaultIntegrationServiceApiPrefix;
        }

        return TiknasAspNetCoreConsts.DefaultApiPrefix;
    }
