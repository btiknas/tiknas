...
using Tiknas.AspNetCore.Mvc.ApplicationConfigurations.ObjectExtending;
...
public class TiknasApplicationConfigurationAppService : ApplicationService, ITiknasApplicationConfigurationAppService
{
    private readonly TiknasLocalizationOptions _localizationOptions;
    private readonly TiknasMultiTenancyOptions _multiTenancyOptions;
    ...
    private readonly TiknasClockOptions _tiknasClockOptions;
    private readonly ICachedObjectExtensionsDtoService _cachedObjectExtensionsDtoService;
    private readonly TiknasApplicationConfigurationOptions _options;

    public TiknasApplicationConfigurationAppService(
        IOptions<TiknasLocalizationOptions> localizationOptions,
        IOptions<TiknasMultiTenancyOptions> multiTenancyOptions,
        ...
        IOptions<TiknasClockOptions> tiknasClockOptions,
        ICachedObjectExtensionsDtoService cachedObjectExtensionsDtoService,
        IOptions<TiknasApplicationConfigurationOptions> options)
    {
        ...
        _tiknasClockOptions = tiknasClockOptions.Value;
    ...
    public virtual async Task<ApplicationConfigurationDto> GetAsync(ApplicationConfigurationRequestOptions options)
    {
        ...
        Logger.LogDebug("Executing TiknasApplicationConfigurationAppService.GetAsync()...");
        ...
        Logger.LogDebug("Executed TiknasApplicationConfigurationAppService.GetAsync().");
    ...
    protected virtual async Task<ApplicationAuthConfigurationDto> GetAuthConfigAsync()
    {
        ...
        var policyNames = await _tiknasAuthorizationPolicyProvider.GetPoliciesNamesAsync();
        var tiknasPolicyNames = new List<string>();
        ...
        foreach (var policyName in policyNames)
        {
            ...
            {
                tiknasPolicyNames.Add(policyName);
            }
            else
            {
        ...
        var result = await _permissionChecker.IsGrantedAsync(tiknasPolicyNames.ToArray());
    ...
    protected virtual ClockDto GetClockConfig()
    {
        return new ClockDto
        {
            Kind = Enum.GetName(typeof(DateTimeKind), _tiknasClockOptions.Kind)!
        };
    }
}
