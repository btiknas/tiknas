...
public class TiknasAutoValidateAntiforgeryTokenAttribute : Attribute, IFilterFactory, IOrderedFilter
{
    /// <summary>
    ...
    {
        return serviceProvider.GetRequiredService<TiknasAutoValidateAntiforgeryTokenAuthorizationFilter>();
    }
}
