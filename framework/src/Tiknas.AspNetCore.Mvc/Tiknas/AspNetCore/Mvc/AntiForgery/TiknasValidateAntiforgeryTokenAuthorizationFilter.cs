...
public class TiknasValidateAntiforgeryTokenAuthorizationFilter : IAsyncAuthorizationFilter, IAntiforgeryPolicy, ITransientDependency
{
    private IAntiforgery _antiforgery;
    private readonly TiknasAntiForgeryCookieNameProvider _antiForgeryCookieNameProvider;
    private readonly ILogger<TiknasValidateAntiforgeryTokenAuthorizationFilter> _logger;

    public TiknasValidateAntiforgeryTokenAuthorizationFilter(
