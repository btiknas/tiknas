...
public class TiknasDataAnnotationAutoLocalizationMetadataDetailsProvider : IDisplayMetadataProvider
{
    ...
    public TiknasDataAnnotationAutoLocalizationMetadataDetailsProvider(IServiceCollection services)
    {
