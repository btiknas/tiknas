...
using Tiknas.AspNetCore.Components.Web.Extensibility;
...
namespace Tiknas.AspNetCore.Components.WebAssembly.Extensibility;
...
public class WebAssemblyLookupApiRequestService : ILookupApiRequestService, ITransientDependency
{
    ...
    public async Task<string> SendAsync(string url)
    {
        ...
        if (!uri.IsAbsoluteUri)
        {
            ...
            {
                throw new TiknasException("Remote service configuration 'Default' was not found!");
            }
