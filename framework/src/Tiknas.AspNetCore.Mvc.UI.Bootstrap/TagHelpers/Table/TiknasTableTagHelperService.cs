...
public class TiknasTableTagHelperService : TiknasTagHelperService<TiknasTableTagHelper>
{
    ...
    protected virtual void SetBorderStyle(TagHelperContext context, TagHelperOutput output)
    {
        ...
        {
            case TiknasTableBorderStyle.Default:
                return;
            case TiknasTableBorderStyle.Bordered:
                output.Attributes.AddClass("table-bordered");
                return;
            case TiknasTableBorderStyle.Borderless:
