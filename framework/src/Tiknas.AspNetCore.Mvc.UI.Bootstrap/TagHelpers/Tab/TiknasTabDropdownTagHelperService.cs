...
public class TiknasTabDropdownTagHelperService : TiknasTagHelperService<TiknasTabDropdownTagHelper>
{
    ...
    protected virtual string GetTabHeaderItem(TagHelperContext context, TagHelperOutput output)
    {
        ...
        menu.InnerHtml.Append(TiknasTabDropdownItemsActivePlaceholder);
