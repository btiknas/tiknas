...
public class TiknasBreadcrumbTagHelperService : TiknasTagHelperService<TiknasBreadcrumbTagHelper>
{
    ...
    {
        return item.Active ?
            item.Html.Replace(TiknasBreadcrumbItemActivePlaceholder, " active") :
            item.Html.Replace(TiknasBreadcrumbItemActivePlaceholder, "");
    }
