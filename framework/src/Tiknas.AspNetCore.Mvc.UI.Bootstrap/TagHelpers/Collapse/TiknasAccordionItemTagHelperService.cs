...
public class TiknasAccordionItemTagHelperService : TiknasTagHelperService<TiknasAccordionItemTagHelper>
{
    ...
    protected virtual string GetAccordionContentItem(TagHelperContext context, TagHelperOutput output, TagHelperContent content)
    {
        ...
        wrapper.Attributes.Add("data-bs-parent", "#" + TiknasAccordionParentIdPlaceholder);
