...
public class TiknasAccordionTagHelperService : TiknasTagHelperService<TiknasAccordionTagHelper>
{
    protected IHtmlGenerator HtmlGenerator { get; }

    public TiknasAccordionTagHelperService(IHtmlGenerator htmlGenerator)
    {
    ...
    protected virtual void SetContent(TagHelperContext context, TagHelperOutput output, List<string> items)
    {
        ...
        {
            var content = item.Replace(TiknasAccordionParentIdPlaceholder, HtmlGenerator.Encode(TagHelper.Id));
