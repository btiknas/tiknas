...
public class TiknasCollapseButtonTagHelperService : TiknasTagHelperService<TiknasCollapseButtonTagHelper>
{
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (output.TagName == "tiknas-button" || output.TagName == "button")
        {
