...
public class TiknasSelectTagHelper : TiknasTagHelper<TiknasSelectTagHelper, TiknasSelectTagHelperService>
{
    ...
    public TiknasSelectTagHelper(TiknasSelectTagHelperService tagHelperService)
