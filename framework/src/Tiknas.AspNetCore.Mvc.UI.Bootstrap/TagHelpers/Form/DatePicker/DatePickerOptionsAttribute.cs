...
public class DatePickerOptionsAttribute : Attribute
{
    ...
    public ITiknasDatePickerOptions? GetDatePickerOptions(ModelExplorer explorer)
    {
        ...
        return properties.FirstOrDefault(p=> p.Model is ITiknasDatePickerOptions)?.Model as ITiknasDatePickerOptions;
    }
}