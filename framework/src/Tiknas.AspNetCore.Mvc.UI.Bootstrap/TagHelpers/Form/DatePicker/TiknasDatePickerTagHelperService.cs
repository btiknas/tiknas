...
public class TiknasDatePickerTagHelperService : TiknasDatePickerBaseTagHelperService<TiknasDatePickerTagHelper>
{
    public TiknasDatePickerTagHelperService(IJsonSerializer jsonSerializer, IHtmlGenerator generator, HtmlEncoder encoder, IServiceProvider serviceProvider, IStringLocalizer<TiknasUiResource> l, ITiknasTagHelperLocalizer tagHelperLocalizer) : base(jsonSerializer, generator, encoder, serviceProvider, l, tagHelperLocalizer)
    {
