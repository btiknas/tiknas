...
public interface ITiknasDatePickerOptions
{
    ...
    /// </summary>
    TiknasDatePickerWeekNumbers WeekNumbers { get; set; }
    ...
    /// </summary>
    List<TiknasDatePickerRange>? Ranges { get; set; }
