...
public class TiknasDateRangePickerTagHelperService : TiknasDatePickerBaseTagHelperService<TiknasDateRangePickerTagHelper>
{
    public TiknasDateRangePickerTagHelperService(IJsonSerializer jsonSerializer, IHtmlGenerator generator,
    ...
    protected override string TagName { get; set; } = "tiknas-date-range-picker";
