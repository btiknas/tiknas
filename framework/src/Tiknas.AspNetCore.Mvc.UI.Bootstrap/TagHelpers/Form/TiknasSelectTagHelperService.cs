...
public class TiknasSelectTagHelperService : TiknasTagHelperService<TiknasSelectTagHelper>
{
    private readonly IHtmlGenerator _generator;
    private readonly HtmlEncoder _encoder;
    private readonly ITiknasTagHelperLocalizer _tagHelperLocalizer;
    private readonly IStringLocalizerFactory _stringLocalizerFactory;
    private readonly ITiknasEnumLocalizer _tiknasEnumLocalizer;

    public TiknasSelectTagHelperService(
        IHtmlGenerator generator,
        HtmlEncoder encoder,
        ITiknasTagHelperLocalizer tagHelperLocalizer,
        IStringLocalizerFactory stringLocalizerFactory,
        ITiknasEnumLocalizer tiknasEnumLocalizer)
    {
        _generator = generator;
        _encoder = encoder;
        _tagHelperLocalizer = tagHelperLocalizer;
        _stringLocalizerFactory = stringLocalizerFactory;
        _tiknasEnumLocalizer = tiknasEnumLocalizer;
    }
    ...
    protected virtual List<SelectListItem> GetSelectItemsFromEnum(TagHelperContext context, TagHelperOutput output, ModelExplorer explorer)
    {
        ...
        {
            var localizedMemberName = _tiknasEnumLocalizer.GetString(enumType, enumValue,
                new[]
                {
                    containerLocalizer,
    ...
    protected virtual string GetSize(TagHelperContext context, TagHelperOutput output)
    {
        ...
        {
            TiknasFormControlSize.Small => "form-select-sm",
            TiknasFormControlSize.Medium => "form-select-md",
            TiknasFormControlSize.Large => "form-select-lg",
            _ => "",
        };
    }
