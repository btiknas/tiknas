...
public class TiknasRadioInputTagHelperService : TiknasTagHelperService<TiknasRadioInputTagHelper>
{
    private readonly ITiknasTagHelperLocalizer _tagHelperLocalizer;

    public TiknasRadioInputTagHelperService(ITiknasTagHelperLocalizer tagHelperLocalizer)
    {
