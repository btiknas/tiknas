...
public class TiknasInputTagHelperService : TiknasTagHelperService<TiknasInputTagHelper>
{
    private readonly IHtmlGenerator _generator;
    private readonly HtmlEncoder _encoder;
    private readonly ITiknasTagHelperLocalizer _tagHelperLocalizer;

    public TiknasInputTagHelperService(IHtmlGenerator generator, HtmlEncoder encoder, ITiknasTagHelperLocalizer tagHelperLocalizer)
    {
    ...
    protected virtual string GetSize(TagHelperContext context, TagHelperOutput output)
    {
        ...
        {
            case TiknasFormControlSize.Small:
                return "form-control-sm";
            case TiknasFormControlSize.Medium:
                return "form-control-md";
            case TiknasFormControlSize.Large:
