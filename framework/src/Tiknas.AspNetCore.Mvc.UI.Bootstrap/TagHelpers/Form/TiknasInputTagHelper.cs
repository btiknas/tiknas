...
public class TiknasInputTagHelper : TiknasTagHelper<TiknasInputTagHelper, TiknasInputTagHelperService>
{
    ...
    public TiknasInputTagHelper(TiknasInputTagHelperService tagHelperService)
