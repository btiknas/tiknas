...
public class TiknasCarouselItemTagHelperService : TiknasTagHelperService<TiknasCarouselItemTagHelper>
{
    private readonly HtmlEncoder _encoder;

    public TiknasCarouselItemTagHelperService(HtmlEncoder encoder)
    {
        _encoder = encoder;
    }
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        output.Attributes.AddClass(TiknasCarouselItemActivePlaceholder);
