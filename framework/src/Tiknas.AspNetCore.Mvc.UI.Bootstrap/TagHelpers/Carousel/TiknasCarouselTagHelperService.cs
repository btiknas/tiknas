...
public class TiknasCarouselTagHelperService : TiknasTagHelperService<TiknasCarouselTagHelper>
{
    protected IStringLocalizer<TiknasUiResource> L { get; }

    public TiknasCarouselTagHelperService(IStringLocalizer<TiknasUiResource> localizer)
    {
        L = localizer;
    }
    ...
    {
        item.Html = item.Html.Replace(TiknasCarouselItemActivePlaceholder, item.Active ? "active" : "");
    }
