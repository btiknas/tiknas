...
public class TiknasPaginationTagHelperService : TiknasTagHelperService<TiknasPaginationTagHelper>
{
    ...
    public TiknasPaginationTagHelperService(
    ...
    {
        var localizer = _stringLocalizerFactory.Create(typeof(TiknasUiResource));
