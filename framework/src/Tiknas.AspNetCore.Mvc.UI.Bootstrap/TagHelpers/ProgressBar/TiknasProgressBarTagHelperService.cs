...
public class TiknasProgressBarTagHelperService : TiknasTagHelperService<TiknasProgressBarTagHelper>
{
    ...
    {
        if (TagHelper.Type != TiknasProgressBarType.Default)
        {
    ...
    {
        if (output.TagName == "tiknas-progress-part")
        {
            return;
        }
